...
const eyebrow = 'text-[11px] font-semibold uppercase tracking-[0.25em] text-gray-800 dark:text-white/80';
const bodyText = 'text-sm text-gray-800 dark:text-white/80';
const socialButton =
...
export function InformationPanel({ onAction, actionLabel, className = '' }: InformationPanelProps) {
  return (
    <div
    ...
    >
      <div className="flex flex-col items-start mb-3 gap-2">
        ...
        <h1 className="text-3xl font-black tracking-wide text-gray-900 dark:text-white">Details</h1>
      </div>

      <div className="flex-1 pb-3 text-gray-800 dark:text-white/80 text-sm font-light leading-relaxed">
        <p>
      ...
      <div className="mt-2 space-y-6 pt-4 border-t border-gray-400 dark:border-white/10">
        <div>
