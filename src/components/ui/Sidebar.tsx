...
export function Sidebar({ onNavigate }: SidebarProps) {
  ...
  return (
    <div className="hidden lg:flex w-22 h-160 glass-panel rounded-[44px] flex-col items-center py-6 justify-between relative shadow-2xl shrink-0 pointer-events-auto">
